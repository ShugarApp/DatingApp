...
tasks.register("refactorPackage") {
    ...
    val newApplicationBundleId = "com.dating.aura" // <-- Change this with new application/bundle ID
    val newApplicationName = "Aura"      //  <-- Change this with new application name


    val oldApplicationBundleId = "com.plcoding.chirp" // <-- Default application/bundle id and package name
    val oldApplicationName = "Chirp"       // <-- Default Application Name
